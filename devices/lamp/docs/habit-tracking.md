...
| `os/services/internal/openclaw/resources/SOUL.md` | "Observing Habits" section — conversation intent logging |
...
| `os/services/internal/openclaw/onboarding.go` | Registers habit in skills list |
