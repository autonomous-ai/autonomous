...
|---|---|---|---|
| Voice (Mic 1) | USB mic (`lamp_usb_mic` card) | `plug:lamp_micro2` | `/opt/hal/.env` (`LELAMP_AUDIO_INPUT_ALSA`) |
| Sensing (Mic 2) | onboard codec capture | `plug:lamp_micro1` | `/opt/hal/.env` (`LELAMP_AUDIO_SENSING_DEVICE`) |
