...
const helpText = `
mock-device REPL — type a command to send it to the paired buddy.
...
Vision / click / mouse:
  screenshot [scale]                e.g. "screenshot 0.5" — saves to ~/Library/Application Support/AutonomousBuddy/screenshots/latest.png
